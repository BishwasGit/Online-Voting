...
<div style="display: flex; justify-content: space-between;flex-direction:row-reverse;">
    <div><a href="./adminboard.php" class="style">Back</a></div>
</div>

<body>
    <center>
        <div class="login-box1">
            <form action="../api/adminregister.php" class="was-validated" id="form2" method="POST" enctype="multipart/form-data" style="margin-top:30px;">
                <h3>Registration</h3>
                <!-- <div>
